/**
 * Build profile for webassets-require.
 * 
 * This supports all the normal configuration available to a r.js build profile. The only gotchas are:
 *
 *   - 'baseUrl' will be overidden by webassets-require during the build process.
 *   - 'appDir' will be overidden by webassets-require during the build process.
 *   - 'dir' will be overidden by webassets-require during the build process. 
 */
({
